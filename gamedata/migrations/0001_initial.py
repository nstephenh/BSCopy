# Generated by Django 5.1.2 on 2024-11-21 19:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subheadings', to='gamedata.unit')),
            ],
        ),
        migrations.AddField(
            model_name='profile',
            name='unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='profiles', to='gamedata.unit'),
        ),
        migrations.CreateModel(
            name='RawErrata',
            fields=[
