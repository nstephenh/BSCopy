...
def clone_cat(output_name, assign_ids_to_mods_and_cons=False):
    ...
    update_all_node_ids(tree2.iter(), node_map, assign_ids_to_mods_and_cons=assign_ids_to_mods_and_cons)
